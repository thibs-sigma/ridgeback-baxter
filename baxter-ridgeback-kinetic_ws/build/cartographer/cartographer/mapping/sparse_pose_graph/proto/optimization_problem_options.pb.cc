...
void protobuf_AssignDesc_cartographer_2fmapping_2fsparse_5fpose_5fgraph_2fproto_2foptimization_5fproblem_5foptions_2eproto() {
  ...
  static const int OptimizationProblemOptions_offsets_[9] = {
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 255) {
    ZR_(huber_scale_, fixed_frame_pose_rotation_weight_);
    log_solver_summary_ = false;
  }
...
void OptimizationProblemOptions::MergeFrom(const OptimizationProblemOptions& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_fixed_frame_pose_translation_weight()) {
      set_fixed_frame_pose_translation_weight(from.fixed_frame_pose_translation_weight());
    }
    if (from.has_fixed_frame_pose_rotation_weight()) {
