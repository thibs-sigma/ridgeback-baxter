...
void protobuf_AssignDesc_cartographer_2fmapping_5f2d_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_2eproto() {
  ...
  static const int LocalTrajectoryBuilderOptions_offsets_[16] = {
...
void protobuf_AddDesc_cartographer_2fmapping_5f2d_2fproto_2flocal_5ftrajectory_5fbuilder_5foptions_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "g_data_ray_length\030\020 \001(\002\022\036\n\026scans_per_acc"
    "umulation\030\023 \001(\005\022\031\n\021voxel_filter_size\030\003 \001"
    "(\002\022\\\n\035adaptive_voxel_filter_options\030\006 \001("
    "\01325.cartographer.sensor.proto.AdaptiveVo"
    "xelFilterOptions\022i\n*loop_closure_adaptiv"
    "e_voxel_filter_options\030\024 \001(\01325.cartograp"
    "her.sensor.proto.AdaptiveVoxelFilterOpti"
    "ons\022,\n$use_online_correlative_scan_match"
    "ing\030\005 \001(\010\022\206\001\n*real_time_correlative_scan"
    "_matcher_options\030\007 \001(\0132R.cartographer.ma"
    "pping_2d.scan_matching.proto.RealTimeCor"
    "relativeScanMatcherOptions\022h\n\032ceres_scan"
    "_matcher_options\030\010 \001(\0132D.cartographer.ma"
    "pping_2d.scan_matching.proto.CeresScanMa"
    "tcherOptions\022Q\n\025motion_filter_options\030\r "
    "\001(\01322.cartographer.mapping_3d.proto.Moti"
    "onFilterOptions\022!\n\031imu_gravity_time_cons"
    "tant\030\021 \001(\001\022F\n\017submaps_options\030\013 \001(\0132-.ca"
    "rtographer.mapping_2d.proto.SubmapsOptio"
    "ns\022\024\n\014use_imu_data\030\014 \001(\010", 1344);
...
#define ZR_(first, last) do {                              \
  ...
  if (_has_bits_[0 / 32] & 255) {
    ZR_(min_range_, scans_per_accumulation_);
    voxel_filter_size_ = 0;
  ...
  if (_has_bits_[8 / 32] & 65280) {
    ...
    if (has_loop_closure_adaptive_voxel_filter_options()) {
      if (loop_closure_adaptive_voxel_filter_options_ != NULL) loop_closure_adaptive_voxel_filter_options_->::cartographer::sensor::proto::AdaptiveVoxelFilterOptions::Clear();
    }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 17: {
        ...
        if (input->ExpectTag(152)) goto parse_scans_per_accumulation;
        break;
      }
...
void LocalTrajectoryBuilderOptions::SerializeWithCachedSizes(
  ...
  if (has_scans_per_accumulation()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(19, this->scans_per_accumulation(), output);
  }

  // optional .cartographer.sensor.proto.AdaptiveVoxelFilterOptions loop_closure_adaptive_voxel_filter_options = 20;
  if (has_loop_closure_adaptive_voxel_filter_options()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      20, this->loop_closure_adaptive_voxel_filter_options(), output);
  }
...
::google::protobuf::uint8* LocalTrajectoryBuilderOptions::SerializeWithCachedSizesToArray(
  ...
  // optional int32 scans_per_accumulation = 19;
  if (has_scans_per_accumulation()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(19, this->scans_per_accumulation(), target);
  }
  ...
  if (has_loop_closure_adaptive_voxel_filter_options()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        20, this->loop_closure_adaptive_voxel_filter_options(), target);
  }
...
int LocalTrajectoryBuilderOptions::ByteSize() const {
  ...
  if (_has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    ...
    if (has_loop_closure_adaptive_voxel_filter_options()) {
      total_size += 2 +
        ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
          this->loop_closure_adaptive_voxel_filter_options());
    }
