...
void protobuf_AssignDesc_cartographer_2fsensor_2fproto_2fsensor_2eproto() {
  ...
  ImuData_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(ImuData));
  OdometryData_descriptor_ = file->message_type(2);
  ...
  OdometryData_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(OdometryData));
  FixedFramePoseData_descriptor_ = file->message_type(3);
  ...
  FixedFramePoseData_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(FixedFramePoseData, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(FixedFramePoseData, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
...
void protobuf_AddDesc_cartographer_2fsensor_2fproto_2fsensor_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "er.transform.proto.Vector3d\"V\n\014OdometryD"
    "ata\022\021\n\ttimestamp\030\001 \001(\003\0223\n\004pose\030\002 \001(\0132%.c"
    "artographer.transform.proto.Rigid3d\"\\\n\022F"
    "ixedFramePoseData\022\021\n\ttimestamp\030\001 \001(\003\0223\n\004"
    "pose\030\002 \001(\0132%.cartographer.transform.prot"
    "o.Rigid3dB\010B\006Sensor", 539);
...
FixedFramePoseData* FixedFramePoseData::New() const {
...
::google::protobuf::uint8* FixedFramePoseData::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
...
void FixedFramePoseData::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const FixedFramePoseData* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const FixedFramePoseData*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
