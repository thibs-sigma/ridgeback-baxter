...
void protobuf_AssignDesc_cartographer_2fmapping_2fproto_2fsubmap_5fvisualization_2eproto() {
  ...
  SubmapQuery_Response_SubmapTexture_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SubmapQuery_Response_SubmapTexture, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SubmapQuery_Response_SubmapTexture, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
...
SubmapQuery_Response_SubmapTexture* SubmapQuery_Response_SubmapTexture::New() const {
...
::google::protobuf::uint8* SubmapQuery_Response_SubmapTexture::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
...
void SubmapQuery_Response_SubmapTexture::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const SubmapQuery_Response_SubmapTexture* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const SubmapQuery_Response_SubmapTexture*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
